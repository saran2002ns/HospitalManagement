...
public class AdminController {
    ...
    public void appoinmentSheduling() {
        ...
        int docterId;
         do{   
            ...
            scanner.nextLine();
            if (!dataBase.getDocters().containsKey(patienId)|| !lookAvailability(dataBase.getPatients().get(patienId),dataBase.getDocters().get(docterId))) {
    ...
    private boolean lookAvailability(Patient patient, Doctor docter) {
         Map<String,List<String>> avalabilSlot = docter.getAvalabilSlot();
    ...
    private void addAppoiment(Integer patientId, Integer docterId, String time, String date) {
